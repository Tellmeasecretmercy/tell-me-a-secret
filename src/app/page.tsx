        ...
        {[...Array(50)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              backgroundColor: Math.random() > 0.5 ? '#fbbf24' : '#a855f7',
              borderRadius: '50%',
              opacity: 0.6,
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      inset: '-2px',
                      borderRadius: '2rem',
                      background: `linear-gradient(45deg, transparent, ${chamber.color}20, transparent)`,
                      opacity: 0,
                    ...
                    {/* Floating Particles for Each Door */}
