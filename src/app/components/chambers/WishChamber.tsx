          ...
          {[...Array(60)].map((_, i) => (
            <motion.div
              ...
              style={{
                ...
                backgroundColor: ['#34d399', '#10b981', '#6ee7b7', '#a7f3d0'][Math.floor(Math.random() * 4)],
                borderRadius: '50%',
      ...
      <div style={{ position: 'absolute', inset: 0 }}>
        {[...Array(40)].map((_, i) => (
          <motion.div
            ...
            style={{
              position: 'absolute',
              width: Math.random() > 0.7 ? '10px' : '5px',
              height: Math.random() > 0.7 ? '10px' : '5px',
              backgroundColor: ['#34d399', '#6ee7b7', '#a7f3d0'][Math.floor(Math.random() * 3)],
              borderRadius: '50%',
              opacity: 0.6,
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
